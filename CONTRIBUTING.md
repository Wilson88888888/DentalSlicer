# Contributing to DentalSlicer

There are many ways to contribute to DentalSlicer.

- Submit a feature request or bug, or add to the discussion on the [DentalSlicer issue tracker][is]
- Submit a [Pull Request][pr] to improve DentalSlicer.

## The PR Process, and Related Gotchas

### How to submit a PR ?

If you are new to DentalSlicer development and you don't have push access to the DentalSlicer
...
When submitting a PR, make sure to add a `Cc: @DentalSlicer/developers` comment to
notify DentalSlicer developers of your awesome contributions. Based on the
...
- You do NOT have push access: A DentalSlicer core developer will integrate your PR.
...
[pr]: https://github.com/Beyondbrain/DentalSlicer/merge_requests
[is]: https://github.com/Beyondbrain/DentalSlicer/issues
